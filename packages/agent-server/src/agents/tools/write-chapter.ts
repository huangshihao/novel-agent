...
export function buildWriteChapterTool(
  ...
  return {
    ...
    promptGuidelines: [
      ...
      '**戏剧节拍蓝图**：按 source.dramatic_beat_blueprint 写出相同的状态变化、压力结构、信息差、情绪曲线和章末承诺，不要还原原作事件链',
      ...
      '**相似风险**：source.similarity_signals 不是禁用清单；允许题材内自然趋同，但不要把整套事件链、人物关系和解决方式写成原作同款',
    ],
